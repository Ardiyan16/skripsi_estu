...
<div class="right_col" role="main">
    ...
    <div class="col-md-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Form Tambah Dataset <small>tambah dataset</small></h2>
            ...
            <div class="x_content">
                <br />
                <form class="form-horizontal form-label-left" method="post" action="<?= base_url('admin/data_set/save_dataset') ?>">
